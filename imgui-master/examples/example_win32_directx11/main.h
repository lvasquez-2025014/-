...
bool aimSilentEnabled = false; // Aimbot silent activado
int headRate = 3;
int chestRate = 3;
int neckShotsCount = 0; // Cantidad de tiros al cuello antes de ir a cabeza (0-5)
extern void DrawFOV(); // Función para dibujar el FOV (siempre activo)
extern void DrawKeybindsHUD(); // Función para dibujar el HUD de keybinds (siempre activo)
bool adbboton = false;
...
// Variables y atajos para el HUD de Keybinds flotante 
//
inline bool ShowKeybindsHUD = true;

bool authenticed = false;
bool loading = false;
bool show_login = true;
static float load_speed = 0.5f; // Velocidad de carga (0.5 = ~2s)
...
namespace font2 {
    // fuentezada moved to font namespace in Esp_line.h
}
