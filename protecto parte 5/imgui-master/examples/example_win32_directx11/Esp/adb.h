...
#include "vector.h"
#include "lib.h"
#include "C:\Users\Asmodeus\Desktop\fixerr\protecto parte 5\imgui-master\MinHook\include\MinHook.h"
#include "offset.h"
...
// Lectura de string/buffer con tamaño específico
bool ReadZ(uintptr_t address, void* buffer, size_t size) {
    uintptr_t physAddress;
    return ConvertZ(address, physAddress) && (zHookRead(pVMAddr, physAddress, buffer, size) == 0);
}
