...
inline const auto zTimeMs = std::chrono::milliseconds(300);
...
// MatchStatusEnum currentMatchStatus = MATCH_NOT_STARTED; // Removido por estar indefinido y sin uso en el proyecto.
...
inline std::atomic<bool> adbThreadRunning = false;
inline std::atomic<bool> adbInitialized = false;
