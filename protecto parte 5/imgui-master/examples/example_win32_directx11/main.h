...
#include <d3d11.h>
#include <C:\Users\Asmodeus\Desktop\fixerr\protecto parte 5\imgui-master\SDK\Include/D3DX11tex.h>
#include <dwmapi.h>
#include <tchar.h>
...
// ESP Variables from Esp_line.h
extern bool EspLineZ;
extern bool ESPBox;
extern bool ESPBones;
extern bool ESPNameZ;
extern bool ESPHealth;
extern bool EspWeaponsICON;
extern bool EspWeaponsTex;
extern bool Shadow;
extern bool rainbowMode;
extern bool rgbMode;
extern bool ShowTeam;
extern bool ShowInvis;
extern bool ESPFillBox;
extern bool ShowFov;
extern bool ESPShield;
...
extern bool FastFire;
extern bool QuickSwitchHack;
extern bool MedikitHackNew;
extern int SelectedESPBoxStyle;
extern int SelectedLineStyle;
extern int maxDistance;
extern float lineThicknessBase;
extern int Fovcosmos;
extern int SelectedAimBone;
extern int SelectedAimKey;
extern float aimSmooth;

// Hotkey system
extern int AimHotkey;
extern int SpeedHotkey;

// Variables de Asistencia de Apuntado (Aim Assist) - versión vieja
extern bool g_AimAssist;
extern bool g_AimTeammates;
extern int g_AimAssistType; // 0: Memory Lock, 1: Memory Smooth, 2: Mouse Emulation, 3: Silent Aim
extern float g_AimSmoothness; // 0.0f - 1.0f (0 = instantáneo, 1 = súper suave/lento)
extern int g_ChestShotsCount; // 0: Desactivado, 1-5: Tiros iniciales al pecho, luego cabeza
