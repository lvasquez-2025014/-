...
// UI/Cheat configuration variables to prevent undeclared identifier errors
inline bool EnabledEsp = false;
inline HWND hdPlayerWindow = nullptr;
inline bool ESPBox = false;
inline bool ESPFillBox = false;
inline bool ESPNameZ = false;
inline bool ESPBones = false;
inline bool ESPHealth = false;
inline bool EspLineZ = false;
inline float velocidadcaida = 1.0f;
inline int InfinitySliders = 1000;
inline bool EspWeaponsICON = false;
inline bool ShowInvis = false;
inline bool TeleportBase = false;
inline bool PullPlayer = false;
inline bool caidarapida = false;
inline bool InfiniteBullents = false;
inline bool ESPHealthMAX = false;
inline bool EspWeaponsTex = false;
inline bool AimbotRotation = false;
inline int SelectedPullBone = 0;
inline const char* PullBoneOptions[] = { "Head", "Neck", "Torso", "Hip" };
inline int FovAll = 150;
inline int VisionSlider = 2000;
inline bool UpCheck = false;
inline bool NoRecoil = false;
inline bool VisionHack = false;
inline bool FlyWall = false;
inline bool noreloadpro = false;
inline bool MedikitFast = false;

inline ImFont* Nev1 = nullptr;
